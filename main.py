...
parser.add_argument('--epoch', dest='epoch', type=int, default=308, help='number of total epoches')
...
parser.add_argument('--eval_every_epoch', dest='eval_every_epoch', default=308, help='evaluating and saving checkpoints every #  epoch')
...
def lowlight_train(lowlight_enhance):
    ...
    eval_high_data_name = glob('./data/eval/high/*.*')
